...
#define CONFIG_AWS_IOT_MQTT_HOST "agmifj4pfovqv-ats.iot.ap-southeast-2.amazonaws.com"
...
#define CONFIG_MQTT_TASK_CORE_SELECTION_ENABLED 1
#define CONFIG_MQTT_TASK_CORE_SELECTION 0
